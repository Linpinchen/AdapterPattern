...
namespace TemperatureConversionPJ
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FahrenheitToCelsiusAdapter fahrenheitToCelsius = new FahrenheitToCelsiusAdapter(Fo);
            Console.WriteLine($"華氏溫度:{Fo.GetTemperature()}轉換成攝氏溫度:{fahrenheitToCelsius.GetTemperator()}");
            Console.Read();
        }
    }
}
